<template>
	...
	>
		...
		>
			...
			>
				<header class="gray- h-11 flex cursor-pointer items-center gap-2 px-4">
				...
				<motion.div
					...
					class="mb-2 h-full max-h-60 flex flex-col gap-1 overflow-y-auto px-4 text-sm"
				>
					<slot />
				</motion.div>
			</motion.div>
...
import AnimatedCircularProgressBar from '~/components/inspira/miscellaneous/AnimatedCircularProgressBar.vue'
